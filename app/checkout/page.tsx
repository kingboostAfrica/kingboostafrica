...
export default function CheckoutPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="max-w-xl mx-auto px-5 py-24 text-center">
        <p className="text-kb-charcoal/60">Your cart is empty.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-xl mx-auto px-5 py-12">
      <h1 className="font-display text-3xl font-semibold text-kb-charcoal mb-2">
        Checkout
      </h1>
      <p className="text-kb-charcoal/60 mb-8">
        Total: <span className="text-kb-green font-semibold">₦{total.toLocaleString()}</span>
      </p>
