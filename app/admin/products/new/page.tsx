  ...
  return (
    <div className="max-w-xl mx-auto px-5 py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-kb-charcoal mb-1">Product name</label>
          <input
            required
            value={form.name}
        ...
        <div>
          <label className="block text-sm font-medium text-kb-charcoal mb-1">Category</label>
          <select
            required
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="col-span-1">
            <label className="block text-sm font-medium text-kb-charcoal mb-1">Unit</label>
            <input
              value={form.unit}
          ...
          <div className="col-span-1">
            <label className="block text-sm font-medium text-kb-charcoal mb-1">Stock</label>
            <input
              required
              type="number"
              min="0"
        ...
        <div>
          <label className="block text-sm font-medium text-kb-charcoal mb-1">Photos</label>
          <input
            type="file"
            accept="image/*"
            multiple
