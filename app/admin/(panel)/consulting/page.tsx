          ...
          {list.map((service) => (
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-end gap-2 shrink-0 max-w-[13rem] sm:max-w-none">
                <Link
                  href={`/admin/consulting/${service.id}/edit`}
                ...
                <DeleteButton table="consulting_services" id={service.id} confirmText="Delete this service permanently? This also deletes its bookings." />
              </div>
            </div>
          ))}
        </div>
